	...
	class MyChannel implements Runnable {
		...
		public MyChannel(Socket client) {
			try {
				...
				// 并向其他客户端通道发送新入成员信息
				this.GMsendOthers("欢迎新入成员" + this.name + "加入我们的聊天室");
		...
		/**
		 * 管理员，将数据传出给其他客户端通道,或者私聊形式传出给单独某个客户端
		 * @param msg 要传出去的信息
		 */
